...
function add_light(a){
 ...
 return;
 scene += ';' + (a+1) + ';';
 scene += document.getElementsByName('ad')[a*3].value + ';';
 scene += document.getElementsByName('ad')[a*3 + 1].value + ';';
 var n = 256;
 var p = 0;
 for (var k = 0; k < 6; k++){
  n=n/2;
...
function add_room(){
 ...
 return;
 bscene += ';' + document.getElementsByName('ar')[0].value;
 edit();
 editData();
}

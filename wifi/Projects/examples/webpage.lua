...
function scene(){
 ...
 var rf = i + 1;
 out += '<button style="height:160px; width:320px; font-size:400%" onclick=\'sendScene("' + rf + '")\'>';
 out += arr[i] + '</button>';
 }
 out +='</tr></table>';
...
function light(r){
 ...
 out += '<button style="height:160px; width:320px; font-size:400%; background-color:#00F; color:white" onclick=\'sendRF("' + rf + '")\'>';
...
function ir(b){
 ...
 for(i = 0; i < 40; i++) {
     ...
     out += '<td><button style="height:160px; width:180px; font-size:400%" onclick=\'sendRF("' + ir + '")\'>';
     out += ir_button[i] + '</button></td>';
        }
        else
        if ((i%5) == 4){
    out += '<td><button style="height:160px; width:180px; font-size:400%" onclick=\'ir_ac("' + i + '")\'>';
     out += ir_button[i] + '</button></td>';
        }
        else {
